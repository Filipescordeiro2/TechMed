package com.br.TechMed.service.cliente;
...
public class ClienteService {
    ...
    public ClienteRegisterResponse cadastrarCliente(ClienteRequest request) {
        ...
        try {
            ...
            log.info("Servico de cadastrarCliente Finalizado");
    ...
    public ClienteResponse buscarClientePorCpf(String cpf) {
        ...
        try {
            ...
            log.info("Servico de buscarClientePorCpf Finalizado");
    ...
    public ClienteResponse autenticarCliente(LoginSenhaClienteResquest resquest) {
        ...
        try {
            var clienteEntity = clienteValidation.buscarClientePorLogin(resquest);
